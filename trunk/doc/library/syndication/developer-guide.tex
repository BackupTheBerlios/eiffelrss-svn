...
the subclasses \texttt{CHANNEL\_CLOUD}, \texttt{CHANNEL\_IMAGE},
\texttt{CHANNEL\_TEXT\_INPUT}, \texttt{CHANNEL\_SKIP\_DAYS} and
\texttt{CHANNEL\_SKIP\_HOURS}.
...
\section{Subclass CHANNEL\_SKIP\_DAYS}
\label{sec:channel-skip-days}

\texttt{CHANNEL\_SKIP\_DAYS} inherits from
\texttt{TWO\_WAY\_SORTED\_SET}, so all the features of
\texttt{TWO\_WAY\_SORTED\_SET} are availabe as well.

\subsection{Element change}
\label{sec:channel-skip-days-element-change}
...
\section{Subclass CHANNEL\_SKIP\_HOURS}
\label{sec:channel-skip-hours}

\texttt{CHANNEL\_SKIP\_HOURS} inherits from
\texttt{TWO\_WAY\_SORTED\_SET}, so all the features of
\texttt{TWO\_WAY\_SORTED\_SET} are availabe as well.

\subsection{Element change}
\label{sec:channel-skip-hours-element-change}
