...
% Poster
%===============================================================================
% $Id: poster.tex 213 2005-01-29 15:04:38Z thom $
%===============================================================================
...
%-------------------------------------------------------------------------------
\documentclass[preview,a0,portrait]{a0poster}
    ...
    { 
      ...
      \begin{center}
        \textrm 
        {
          ...
          {\huge Michael Käser, Martin Luder, Thomas Weibel} 
        }
      \end{center}
      \vspace{1cm} 
    } 
...
\begin{multicols}{2}
  ...
  \fcolorbox{black}{backblue}{
    \parbox{1.0\columnwidth}
    {
      ...
      \begin{center}
        \resizebox*{\columnwidth}{!}{\includegraphics{figures/EIFFELRSS_SYNDICATION}}
      \end{center}
    }
  }
  ...
  \fcolorbox{black}{backblue}{
    \parbox{1.0\columnwidth}
    {
      ...
      \begin{center}
        \resizebox*{0.85\columnwidth}{!}{\includegraphics{figures/newsreader}}
      \end{center}

      \begin{center}
        \resizebox*{0.5\columnwidth}{!}{\includegraphics{figures/newsreader_preferences}}
      \end{center}
    }
  }
