...
\texttt{FEED} is the central datastructure. It defines an abstract
syndication feed.
...
\texttt{READERS} defines readers for different syndication formats.
...
\texttt{WRITERS} defines writers for different syndication formats.
...
[TODO: Description, screenshot, BON diagrams]
